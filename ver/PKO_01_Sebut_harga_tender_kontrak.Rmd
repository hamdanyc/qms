...
a. 8.1 Perancangan dan kawalan operasi.

a. 8.2 Keperluan untuk produk dan perkhidmatan.

a. 8.2.2 Semakan Semula Ke Atas Keperluan-Keperluan Perkhidmatan yang Hendak Disampaikan.

# 4.0   Definisi

  a.    E-Perolehan - Aplikasi perolehan dalam talian bagi kementerian/agensi kerajaan.
  
  a.    Keperluan Mandatori - Item-item atau keperluan yang mesti ditawarkan oleh penender sebagai syarat mandatori.
  
  a.    "Letter of Intent" - Surat hasrat yang dikeluarkan oleh kementerian/agensi sebagai setuju-terima 
  tawaran oleh syarikat mengenai sesuatu perolehan oleh kementerian/agensi berkenaan.
  
  a.    "Letter of Acceptance" - Surat yang dikeluarkan oleh kementerian/agensi sebagai setuju-terima 
  tawaran oleh syarikat mengenai sesuatu perolehan oleh kementerian/agensi berkenaan.
...
Eksekutif Jualan  & A.  PERMOHONAN TENDER PEROLEHAN, SEBUT HARGA DAN TAWARAN LOI/LOA       \\
                  ...
                  &                                                                        \\
                  & 2.  Dapatkan sebut harga dari pembekal perkara-perkara 1.              \\
                  &                                                                        \\
...
Eksekutif Jualan  &                                                                        \\
                  & 9.   Sediakan tawaran balas sebagai asas rundingan kontrak.            \\
                  & Butir-butir utama:                                                     \\
...
Kerani            & 13.  Failkan:                                                          \\
                  ...
                  & ii.   LOI/LOA; dan                                                     \\
                  & iii.  kontrak(dimuktamadkan).                                          \\ \hline
\end{tabular}
\end{table}
...
![Sebut harga dan tender](chart/o01-1.png){width=18%}
\newpage

![Tawaran Tender](chart/o01-2.png){width=18%}
\newpage
...
|------|-----------------------------------------|------------------|-----------|-----------|
|1.    |Tawaran tender (Cetakan dari E-Perolehan)|5 tahun           |Bilik Fail |Sulit      |
|2.    |Senarai Sebut Harga Pembekal             |5 tahun           |Bilik Fail |Sulit      |
|3.    |Rundingan Kontrak (dimuktamadkan)        |5 tahun           |Bilik Fail |Sulit      |
|4.    |Letter of Acceptance                     |5 tahun           |Bilik Fail |Sulit      |
