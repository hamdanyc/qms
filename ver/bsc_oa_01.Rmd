...
jika o~i~ dan O~maks~ masing-masing adalah objektif dan jumlah objektif~maks~ yang diukur;  

\begin{align*}
{{KPI}_{i}} &= \frac{\sum_{1}^{n}o_{i}}{O_{{maks}}} \\
\text{di mana:} \\
o_{i} &= \sum_1^nkti_{i}\ast skor_{i}\text{; dan} \\
O_{{maks}} &= \sum_1^nkti_{i}\ast skor_{{i}_{maks}} \\
\text{oleh itu;} \\
KPI_{keseluruhan}&= \frac{\sum_{1}^{n}KPI_{i}}{\sum_{1}^{n}O_{{maks}}}
\end{align*} 
...
a. \% keseluruhan, kepuasan & 70\% ke 100\%   & \%          & 5    & Cemerlang \\
                            ...
                            &                 &             &      &           \\
b. Pembayaran DO,PO dan invois & Kurang 8 hari& hari        & 5    & Cemerlang \\
                            & 14 ke 8 hari    &             & 3    & Memuaskan \\
                            & Lebih 14 hari   &             & 1    & Sederhana \\
                            &                 &             &      &           \\
c. Serahan projek           & Awal dr jadual  & \# serahan  & 5    & Cemerlang \\
...
| c12 | Pelanggan                 | Kepuasan pelanggan                         | # Bayar pembekal 7 hari atau kurang          | # unit     | 25   | 5    | 125   | 125  |
| c14 | Pelanggan                 | Kepuasan pelanggan                         | # Bayar pembekal 8 ke 14 hari                | # unit     | 14   | 3    | 42    | 70   |
| c14 | Pelanggan                 | Kepuasan pelanggan                         | # Bayar pembekal lebih 14 hari               | # unit     | 3    | 1    | 3     | 15   |
...
| c1 | Pelanggan                 | Kepuasan pelanggan      | # Bayar pembekal/<br>Kepuasan pelanggan |# hari | 14      | 13 | 12 | 11 | 10 |
