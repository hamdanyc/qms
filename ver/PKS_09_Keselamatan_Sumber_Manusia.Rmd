...
![Bridging the Gap Between PEOPLE, BUSINESS and TECHNOLOGY](chart/openapps-logo.png){width=30%}
...
|---------------|-----------------------------------------------|
|Pengurus Kewangan/Pentadbiran|1. Merancang untuk mengendalikan kursus/latihan berasaskan bilangan kakitangan dan peruntukan kewangan.|
|               |2. Arahkan Pengurus Kewangan/Pentadbiran mengenalpasti tempat,   |
|               |tarikh, keperluan, peserta kursus dan peruntukan kewangan.|
|               |                                               |
|Pengurus Kewangan/Pentadbiran    |3.  Kenalpasti tempat, tarikh dan keperluan latihan.|
...
|------|----------------------------|---------------------|------|
|1.    |Rekod Kehadiran Peserta Kurus/Latihan|5 Tahun|Bilik Fail|
|2.    |Rekod Kurus/Latihan                  |5 Tahun|Bilik Fail|
|3.    |Laporan Penilaian Kursus/Latihan     |5 Tahun|Bilik Fail|
|4.    |Borang Maklum Balas Kursus/Latihan    |5 Tahun|Bilik Fail|
