![](media/image22.png){width="2.2694444444444444in"
...
| **TERKAWAL**       |                               |
+====================+===============================+
| PK (W).OA.05.(01) | Pengurus Besar Rekod dan Pencen     |
+--------------------+-------------------------------+
| PK (W).OA.05.(02) | Wakil Pengurusan              |
+--------------------+-------------------------------+
| PK (W).OA.05.(03) | Pengurus Kewangan/Pengurusan               |
+--------------------+-------------------------------+
| PK (W).OA.05.(04) | Pengurus Jualan Tadbir/Kor               |
+--------------------+-------------------------------+
| PK (W).OA.05.(05) | Pengurus Jualan ICT                      |
+--------------------+-------------------------------+
| PK (W).OA.05.(06) | Pengurus Jualan Operasi                  |
+--------------------+-------------------------------+
| PK (W).OA.05.(07) | Pengurus Jualan Dasar dan Teknik         |
+--------------------+-------------------------------+
| PK (W).OA.05.(08) | Pengurus Jualan Inspektorat              |
+--------------------+-------------------------------+
| PK (W).OA.05.(09) | Eksekutif Kewangan/Pengurusan                   |
+--------------------+-------------------------------+
| PK (W).OA.05.(10) | PS 3 Koord Operasi            |
+--------------------+-------------------------------+
| PK (W).OA.05.(11) | PS 3 Sel Pegawai              |
+--------------------+-------------------------------+
| PK (W).OA.05.(12) | Penyelia Kanan Markas Operasi |
+--------------------+-------------------------------+
| PK (W).OA.05.(13) | Penyelia Sel Pegawai          |
+--------------------+-------------------------------+
| PK (W).OA.05.(14) | Pengurus Dokumen              |
+--------------------+-------------------------------+
| PK (W).OA.05.(15) | Sekretariat ISO               |
+--------------------+-------------------------------+
...
> Tindakan untuk mencegah dari berlakunya kemungkinan sesuatu
...
5.1 Syarikat - Syarikat.

5.2 Pengurus Besar - Pengurus Besar Rekod Dan Pencen.

5.3 WP - Wakil Pengurusan.

5.4 PD - Pengurus Dokumen.

5.5 PJ - Pengurus Jabatan.
...
+===================+=====+==========================================+
| **WP**            | 1\. | Arahkan PJ untuk mengenalpasti           |
...
|                   |     |     oleh kakitangan dalam Sistem Pengurusan |
|                   |     |     Kualiti dan Pengurusan Keselamatan   |
|                   |     |     Maklumat.                            |
|                   |     |                                          |
|                   |     | iii) Sistem cadangan Syarikat.                |
+-------------------+-----+------------------------------------------+
...
|                   |     | Mesyuarat Kajian Semula jika lengkap.    |
...
|                   |     | dilaksana.                               |
+-------------------+-----+------------------------------------------+
| **WP** {#wp}      | 7\. | Arahkan PJ mengambil tindakan.           |
| ------            |     |                                          |
+-------------------+-----+------------------------------------------+

+---------------------+------+---------------------------------------+
| **PJ**              | 8\.  | Laksanakan tindakan pencegahan dan    |
