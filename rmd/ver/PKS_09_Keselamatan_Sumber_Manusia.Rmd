...
![Bridging the gap between PEOPLE, BUSINESS and TECHNOLOGY](~/R/qms/media/openapps-logo.png){width=30%}
...
|---------------|-----------------------------------------------|
|PS 1 Pengurusan|1. Merancang untuk mengendalikan kursus/latihan berasaskan bilangan kakitangan dan peruntukan kewangan.|
