...
|---------------|-----------------------------------------------|
| WP/TWP        | 1\. Rancangkan tarikh, masa dantempat MKSP menurut persetujuan Ketua Pegawai Eksekutif (CEO).|                   
...
|||
| Ketua Pegawai Eksekutif (CEO)           | 7\.  Mempengerusikan mesyuarat.      |
|||
...
|||
| WP            | 11\. Bincang dengan Ketua Pegawai Eksekutif (CEO) hasil keputusan MKSP mengenai tindakan pembetulan, pencegahan dan penambahbaikan.             |
|||
...
![](~/R/qms/media/s02-01.png){width=80%}\
\newpage
