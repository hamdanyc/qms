...
+--------------------+---------------------------+
| PK (S).OA.06.(03) | PS 1 Pengurusan           |
+--------------------+---------------------------+
| PK (S).OA.06.(04) | Pengurus Kewangan/Pentadbiran/Kor           |
+--------------------+---------------------------+
| PK (S).OA.06.(05) | PTM                  |
+--------------------+---------------------------+
| PK (S).OA.06.(06) | PS 2 Koord Operasi        |
+--------------------+---------------------------+
| PK (S).OA.06.(07) | PS 2 Operasi              |
+--------------------+---------------------------+
| PK (S).OA.06.(08) | PS 2 Inspektorat          |
+--------------------+---------------------------+
| PK (S).OA.06.(09) | Eksekutif Kewangan/Pentadbiran               |
+--------------------+---------------------------+
| PK (S).OA.06.(10) | Kerani Kewangan/Pentadbiran         |
+--------------------+---------------------------+
