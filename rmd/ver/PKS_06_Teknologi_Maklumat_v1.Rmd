...
|                                   |
|:---------------------------------:|
|PROSEDUR PENYELENGGARAAN TEKNOLOGI MAKLUMAT DAN KOMUNIKASI|
...
Prosedur ini menyediakan garispanduan bagi memastikan proses
 ...
 laman web Syarikat dilaksanakan dengan terancang dan berkesan.

# 2.0   Skop

Prosedur ini digunapakai oleh kakitangan Cawangan ICT (*Information,
 Communication and Technology*) semasa untuk menyelenggara sistem
 komputer Syarikat yang meliputi aspek-aspek berikut:

i)    Penyenggaraan Perkakasan dan peralatan komputer, perisian, rangkaian
     sistem komputer dan laman web Syarikat.

i)    Pelupusan Komputer/peralatan perkakasan komputer.

# 3.0   Rujukan

i)    MK.OA.01-- Seksyen 6.3 (infrastruktur).
...
## 4.2    Perkakasan dan peralatan komputer
 ...
 Semua peralatan komputer Syarikat seperti server, komputer mikro,
...
## 4.4    Rangkaian sistem
 ...
 Komputer-komputer individu yang dihubungkan kepada pelayan utama Syarikat
 ...
 *konfigurasi server* *LAN* yang terdapat Syarikat.
...
|               |serahkan Borang ICT 1 kepada TM-Op dan rujuk kepada Proses Pengendalian|
...
|               |                                                |
| TM-Op /    |B. APLIKASINTAUAN KERJA PENYELENGGARAAN             |
| TM-Tek      | (PENCEGAHAN) YANG DIKONTRAKKAN.                |
|               |                                                |
...
|               |          31 - 37)                               |
|               |                                                 |
| PTM      | iii) GANTIAN KOMPONEN DI BAWAH KONTRAK          |
|               |  PENYELENGGARAAN.                               |
|               |                                                 |
...
|               | Pembaikan (Ulangi Langkah 20-22).               |
|               |                                                 |
|               | F. APLIKASINTAUAN KERJA PENYENGGARAAN               |
...
|               |                                                 |
| PTM      | 51\. Pastikan penyenggaraan dibuat mengikut     |
|               | jadual.                                         |
|               |                                                 |
...
|               |                                                 |
|               | 54\. Serahkan laporan kepada TM-Tek untuk      |
|               | difailkan.                                      |
|               |                                                 |
...
|               | Pembaikan (Langkah 20-22).                      |
|               |                                                 |
|               | G. PEMBAIKAN SISTEM APLIKASI DAN PANGKALAN DATA     |
|               |                                                 |
|               |  i) PEMBAIKAN                                   |
|               |                                                 |
...
|               | Pengemaskinian Laman Web Syarikat) (*Lampiran        |
|               | 2*).                                            |
|               |                                                 |
...
|               | penyenggaraan.                                  |
|               |                                                 |
|               | 76\. Serahkan laporan penyenggaraan kepada TM-Tek|
|               | untuk difailkan.                                |
|               |                                                 |
...
|               | ICT 1.                                          |
|               |                                                 |
|               | 78\. Serahkan Borang ICT 1 kepada TM-Tek     |
